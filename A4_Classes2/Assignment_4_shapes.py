...
class RegularPolygon(Polygon):
    def __init__(self, sides, length):
        self.n = sides
        self.length = length
    #overriding abstract method in class Polygon
    def print1(self):
        print("Regular polygon with", self.n , "sides created")
    def __angle(self):
...
class EquiTriangle(RegularPolygon):
    ...
    #Polymorphism : getArea method overwritten
    def getArea(self):        
